...
CREATE TABLE `user`  (
  ...
  `profession` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '职业',
  `hobby` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '爱好',
  `personal_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '个人说明',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '阿沙', '123456', '男', '学生', '音乐_电影_阅读', '页老师的小迷弟');
INSERT INTO `user` VALUES (2, '页老师', '123456', '男', '老师', '电影_阅读_音乐', '世界上最厉害的吉他大师！！！');
